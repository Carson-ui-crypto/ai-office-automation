...
**Visuals & Action**（最重要）
- 必須以固定句開頭：`Full motion animation, smooth 24fps fluid motion, cinematic dynamic video, high motion strength. Overlay the GitHub logo (GitHub-Logo.png) persistently in the top-left corner of every generated frame.`
